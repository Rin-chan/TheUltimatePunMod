...
public enum ModArmorMaterial implements ArmorMaterial {
   BATLE(PunMod.MODID + ":batle", 15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
      return Ingredient.of(Items.IRON_INGOT);
   }),
   DYEMOND(PunMod.MODID + ":dyemond", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, 0.0F, () -> {
      return Ingredient.of(Items.DIAMOND);
   }),
   NETHERDYEMOND(PunMod.MODID + ":netherdyemond", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, 0.0F, () -> {
      return Ingredient.of(Items.DIAMOND);
   }),
   ENDDYEMOND(PunMod.MODID + ":enddyemond", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 0.0F, 0.0F, () -> {
      return Ingredient.of(Items.DIAMOND);
   }),
