...
import github.Rin_Chan.Punmod.item.EndDyemondSwordItem;
...
import github.Rin_Chan.Punmod.item.HoleySwordItem;
...
import github.Rin_Chan.Punmod.item.LuxDyemondSwordItem;
...
import github.Rin_Chan.Punmod.item.NetherDyemondSwordItem;
import github.Rin_Chan.Punmod.item.PaneMakerItem;
import github.Rin_Chan.Punmod.item.PieceMakerItem;
import github.Rin_Chan.Punmod.item.PorkChopperItem;
import github.Rin_Chan.Punmod.item.PunCrossbowItem;
import github.Rin_Chan.Punmod.item.PunisherItem;
...
public class ItemRegistry {
    ...
    public static final RegistryObject<BowItem> OBSIDIEANBOW = ITEMS.register("obsidieanbow", () -> new BowItem((new Item.Properties()).durability(500).tab(ModItemGroup.PUN_MOD)));
    ...
    public static final RegistryObject<PieceMakerItem> PIECEMAKER = ITEMS.register("piecemaker", PieceMakerItem::new);
    public static final RegistryObject<TheGraterSwordItem> THEGRATERSWORD = ITEMS.register("thegratersword", TheGraterSwordItem::new);
    public static final RegistryObject<SwordItem> DYEMONDSWORD = ITEMS.register("dyemondsword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, (new Item.Properties().durability(1800)).tab(ModItemGroup.PUN_MOD)));
    public static final RegistryObject<NetherDyemondSwordItem> NETHERDYEMONDSWORD = ITEMS.register("netherdyemondsword", NetherDyemondSwordItem::new);
    public static final RegistryObject<EndDyemondSwordItem> ENDDYEMONDSWORD = ITEMS.register("enddyemondsword", EndDyemondSwordItem::new);
    public static final RegistryObject<LuxDyemondSwordItem> LUXDYEMONDSWORD = ITEMS.register("luxdyemondsword", LuxDyemondSwordItem::new);
    public static final RegistryObject<SwordItem> OBSIDIEANSWORD = ITEMS.register("obsidieansword", () -> new SwordItem(Tiers.DIAMOND, 3, -2.4F, (new Item.Properties()).tab(ModItemGroup.PUN_MOD)));
    public static final RegistryObject<PunisherItem> PUNISHER = ITEMS.register("punisher", PunisherItem::new);
